...
descricao_nota = 'Descrição dos serviços'
...
#Fazer login
navegador.find_element_by_xpath('//*[@id="login"]').send_keys("seuemail@email.com")
navegador.find_element_by_xpath('//*[@id="senha"]').send_keys("suasenha")
...
navegador.find_element_by_xpath('//*[@id="formNovo"]/div[2]/div[2]/input').send_keys("CNJP_CLIENTE")
navegador.find_element_by_xpath('//*[@id="formNovo"]/div[3]/div[2]/input').send_keys("CEP_CLIENTE")
navegador.find_element_by_xpath('//*[@id="formNovo"]/div[4]/div[2]/input[1]').send_keys("NUM_CLIENTE")
navegador.find_element_by_xpath('//*[@id="formNovo"]/div[5]/div[2]/select').send_keys("PAIS_CLIENTE")
